    ...
    >
      <div className="grid md:grid-cols-2 max-w-[1240px] m-auto">
        <div className="flex flex-col justify-center md:items-start w-full px-2 py-2">
          ...
          <h1 className="my-3 text-5xl md:text-7xl font-bold">
            Cloud Management{" "}
          </h1>
        ...
        <div
          className="absolute flex flex-col py-8 md:min-w-[760px] bottom-[5%]
            mx-1 md:left-1/2 transform md:-translate-x-1/2 bg-zinc-200 border-slate-300
        ...
        >
          ...
          <div className="flex justify-between flex-wrap px-4">
            ...
            <p className="flex px-4 py-2 text-slate-500">
              <CalendarIcon className="h-6 text-indigo-600" /> AIP
            </p>
          </div>
        </div>
      </div>
