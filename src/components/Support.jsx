...
import SupportImg from "../assets/image2.jpg";
      ...
      <div className="max-w-[1240px] mx-auto text-white relative">
        <div className=" px-4 py-14">
          ...
          <p className="py-4 text-3xl text-slate-300">
            ...
            nisi sed nemo, dolore neque excepturi, numquam unde quaerat deleniti
            id nesciunt rem cupiditate odit voluptas quisquam quasi nam minima!
          </p>
        </div>
        ...
        <div className="grid grid-col-1 lg:grid-cols-3 relative gap-x-8 gap-y-16 px-4 pt-12 sm:pt-20 text-black">
          <div className="bg-white rounded-xl shadow-2xl">
            <div className="p-8">
              ...
              <p className="text-gray-600 text-xl">
                ...
                totam cumque a officia harum beatae autem voluptates at et
          ...
          <div className="bg-white rounded-xl shadow-2xl">
            <div className="p-8">
              ...
              <h3 className="font-bold text-2xl my-6">Media Inpuiries</h3>
              <p className="text-gray-600 text-xl">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Quia ex
                totam cumque a officia harum beatae autem voluptates at et
                voluptate accusantium.
